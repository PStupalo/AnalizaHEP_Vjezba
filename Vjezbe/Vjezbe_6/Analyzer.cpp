...
// ovdje ubacujemo i definiramo "nase" funkcije (PlotHistogram, PlotMass, CreateLegend, SavePlots)

void Analyzer::PlotHistogram(TString input_file_name)
{
	c = new TCanvas("c","c",900,900); //definiramo platno
	c->Divide(2,2); //dijelimo platno na 4 (2x2) dijela

	c->cd(1); //prvi dio
	gPad->SetLeftMargin(0.15);
	
	// Kreiramo histograme i postavljamo boje
  for (int i = 0; i < 4; i++) //4 dijela (histograma)
  {
